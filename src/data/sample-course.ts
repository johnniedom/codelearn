...
export const SAMPLE_COURSE: Course = {
  ...
  authors: [
    {
      name: 'CodeLearn Team',
      email: 'team@codelearn.edu',
      organization: 'CodeLearn Foundation',
      bio: 'Dedicated to making coding education accessible to everyone.',
      url: 'https://codelearn.edu',
    },
  ],
  ...
  difficulty: 'beginner',
  learningObjectives: [
    { id: 'obj-1', description: { default: 'Understand variables and data types' }, level: 'understand' },
    { id: 'obj-2', description: { default: 'Write conditional statements' }, level: 'apply' },
    { id: 'obj-3', description: { default: 'Create and use functions' }, level: 'apply' },
  ],
  prerequisites: [],
...
export const SAMPLE_MODULE: Module = {
  ...
  icon: '🚀',
  learningObjectives: [
    { id: 'mod-obj-1', description: { default: 'Set up Python environment' }, level: 'apply' },
    { id: 'mod-obj-2', description: { default: 'Understand variables' }, level: 'understand' },
  ],
  prerequisites: [],
  estimatedMinutes: 90,
  lessons: [
...
export const SAMPLE_LESSON: Lesson = {
  ...
  learningObjectives: [
    { id: 'les-obj-1', description: { default: 'Define what a variable is' }, level: 'remember' },
    { id: 'les-obj-2', description: { default: 'Create and assign variables' }, level: 'apply' },
  ],
  estimatedMinutes: 15,
  readingMinutes: 10,
  practiceMinutes: 5,
...
export const SAMPLE_LESSON_2: Lesson = {
  ...
  learningObjectives: [
    { id: 'les2-obj-1', description: { default: 'Identify the four basic data types in Python' }, level: 'remember' },
    { id: 'les2-obj-2', description: { default: 'Use the type() function to check data types' }, level: 'apply' },
    { id: 'les2-obj-3', description: { default: 'Convert between different data types' }, level: 'analyze' },
  ],
  estimatedMinutes: 20,
  readingMinutes: 12,
  practiceMinutes: 8,
...
export const SAMPLE_LESSON_3: Lesson = {
  ...
  learningObjectives: [
    { id: 'les3-obj-1', description: { default: 'Use all arithmetic operators in Python' }, level: 'apply' },
    { id: 'les3-obj-2', description: { default: 'Understand operator precedence (order of operations)' }, level: 'understand' },
    { id: 'les3-obj-3', description: { default: 'Apply operators to solve practical problems' }, level: 'apply' },
  ],
  estimatedMinutes: 25,
  readingMinutes: 15,
  practiceMinutes: 10,
...
export const SAMPLE_LESSON_4: Lesson = {
  ...
  learningObjectives: [
    { id: 'les4-obj-1', description: { default: 'Define what a string is' }, level: 'remember' },
    { id: 'les4-obj-2', description: { default: 'Explain string concatenation' }, level: 'understand' },
    { id: 'les4-obj-3', description: { default: 'Create and combine strings' }, level: 'apply' },
  ],
  estimatedMinutes: 25,
  readingMinutes: 15,
  practiceMinutes: 10,
...
export const SAMPLE_LESSON_5: Lesson = {
  ...
  learningObjectives: [
    { id: 'les5-obj-1', description: { default: 'Recall the two Boolean values' }, level: 'remember' },
    { id: 'les5-obj-2', description: { default: 'Explain when Booleans are used' }, level: 'understand' },
    { id: 'les5-obj-3', description: { default: 'Create comparison expressions' }, level: 'apply' },
  ],
  estimatedMinutes: 15,
  readingMinutes: 10,
  practiceMinutes: 5,
...
export const SAMPLE_LESSON_6: Lesson = {
  ...
  learningObjectives: [
    { id: 'les6-obj-1', description: { default: 'Recall the input() function syntax' }, level: 'remember' },
    { id: 'les6-obj-2', description: { default: 'Explain that input() always returns a string' }, level: 'understand' },
    { id: 'les6-obj-3', description: { default: 'Convert input to appropriate data types' }, level: 'analyze' },
  ],
  estimatedMinutes: 20,
  readingMinutes: 12,
  practiceMinutes: 8,
...
export const SAMPLE_LESSON_7: Lesson = {
  ...
  learningObjectives: [
    { id: 'les7-obj-1', description: { default: 'Identify the if, elif, else keywords' }, level: 'remember' },
    { id: 'les7-obj-2', description: { default: 'Explain how conditions control program flow' }, level: 'understand' },
    { id: 'les7-obj-3', description: { default: 'Write conditional statements with multiple branches' }, level: 'apply' },
  ],
  estimatedMinutes: 30,
  readingMinutes: 18,
  practiceMinutes: 12,
...
export const SAMPLE_LESSON_8: Lesson = {
  ...
  learningObjectives: [
    { id: 'les8-obj-1', description: { default: 'List all six comparison operators' }, level: 'remember' },
    { id: 'les8-obj-2', description: { default: 'Explain the difference between = and ==' }, level: 'understand' },
    { id: 'les8-obj-3', description: { default: 'Use comparison operators in conditions' }, level: 'apply' },
  ],
  estimatedMinutes: 20,
  readingMinutes: 12,
  practiceMinutes: 8,
...
export const SAMPLE_LESSON_9: Lesson = {
  ...
  learningObjectives: [
    { id: 'les9-obj-1', description: { default: 'Identify and, or, not operators' }, level: 'remember' },
    { id: 'les9-obj-2', description: { default: 'Explain how to combine multiple conditions' }, level: 'understand' },
    { id: 'les9-obj-3', description: { default: 'Write complex conditional expressions' }, level: 'apply' },
  ],
  estimatedMinutes: 20,
  readingMinutes: 12,
  practiceMinutes: 8,
...
export const SAMPLE_LESSON_10: Lesson = {
  ...
  learningObjectives: [
    { id: 'les10-obj-1', description: { default: 'Identify the while loop syntax' }, level: 'remember' },
    { id: 'les10-obj-2', description: { default: 'Explain how while loops continue until condition is False' }, level: 'understand' },
    { id: 'les10-obj-3', description: { default: 'Create loops with proper termination conditions' }, level: 'apply' },
  ],
  estimatedMinutes: 25,
  readingMinutes: 15,
  practiceMinutes: 10,
...
export const SAMPLE_LESSON_11: Lesson = {
  ...
  learningObjectives: [
    { id: 'les11-obj-1', description: { default: 'Identify the for loop syntax' }, level: 'remember' },
    { id: 'les11-obj-2', description: { default: 'Explain iteration over sequences' }, level: 'understand' },
    { id: 'les11-obj-3', description: { default: 'Use range() to control iterations' }, level: 'apply' },
  ],
  estimatedMinutes: 25,
  readingMinutes: 15,
  practiceMinutes: 10,
...
export const SAMPLE_LESSON_12: Lesson = {
  ...
  learningObjectives: [
    { id: 'les12-obj-1', description: { default: 'Define what a list is' }, level: 'remember' },
    { id: 'les12-obj-2', description: { default: 'Explain list indexing' }, level: 'understand' },
    { id: 'les12-obj-3', description: { default: 'Create lists and access elements' }, level: 'apply' },
  ],
  estimatedMinutes: 30,
  readingMinutes: 18,
  practiceMinutes: 12,
...
export const SAMPLE_LESSON_13: Lesson = {
  ...
  learningObjectives: [
    { id: 'les13-obj-1', description: { default: 'List common list methods' }, level: 'remember' },
    { id: 'les13-obj-2', description: { default: 'Explain mutable vs immutable' }, level: 'understand' },
    { id: 'les13-obj-3', description: { default: 'Add, remove, and modify list items' }, level: 'apply' },
  ],
  estimatedMinutes: 25,
  readingMinutes: 15,
  practiceMinutes: 10,
...
export const SAMPLE_LESSON_14: Lesson = {
  ...
  learningObjectives: [
    { id: 'les14-obj-1', description: { default: 'Identify function definition syntax' }, level: 'remember' },
    { id: 'les14-obj-2', description: { default: 'Explain why functions are useful' }, level: 'understand' },
    { id: 'les14-obj-3', description: { default: 'Define and call simple functions' }, level: 'apply' },
  ],
  estimatedMinutes: 30,
  readingMinutes: 18,
  practiceMinutes: 12,
...
export const SAMPLE_LESSON_15: Lesson = {
  ...
  learningObjectives: [
    { id: 'les15-obj-1', description: { default: 'Define parameter and argument' }, level: 'remember' },
    { id: 'les15-obj-2', description: { default: 'Explain return values' }, level: 'understand' },
    { id: 'les15-obj-3', description: { default: 'Create functions with parameters and returns' }, level: 'apply' },
  ],
  estimatedMinutes: 30,
  readingMinutes: 18,
  practiceMinutes: 12,
